    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        public void add(ActionEvent e){
            ...
            try{
                ...
                Parent root2= FXMLLoader.load(getClass().getResource("/customer.controller/CustomerController2.fxml"));
        ...
        public void delete(ActionEvent e) {
            ...
            customerListController.remove(selected);
            CustomerManager.delete(selected);
            CustomerManagerDAO.delete(selected);
        }
    }